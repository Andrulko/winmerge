...
;Types
TypicalInstallation=Typická intalácia
FullInstallation=Plná intalácia
CompactInstallation=Kompaktná intalácia
CustomInstallation=Vlastná intalácia
...
ChineseSimplifiedLanguage=Èínske (zjednoduená) ponuky a dialógy
...
SpanishLanguage=panielske ponuky a dialógy
SwedishLanguage=védske ponuky a dialógy
...
ViewStartMenuFolder=&Zobrazi adresár WinMerge z ponuky tart

;Code Dialogs
DeletePreviousStartMenu=Intalátor zistil, e ste zmenili umiestnenie váej ponuky tart z "%s" na "%s". eláte si zmaza predchádzajúci adresár ponuky tart?
