...
AddToPath=&Dodaj folder WinMerge do cie¿ki systemowej
...
MergeAtCenterPane=Scal w rodkowym panelu
...
ViewStartMenuFolder=&Wywietl folder menu Start WinMerge

;Code Dialogs
DeletePreviousStartMenu=Instalator wykry³, ¿e zmieni³e lokalizacjê menu startowego z "%s" na "%s". Czy usun¹æ poprzedni folder menu startowego?
