...
GreekLanguage=Gr誑ke menuer og dialoger
...
AddToPath=&Tilf WinMerge folderen til din system path
...
;Code Dialogs
DeletePreviousStartMenu=Installationsprogrammet har detekteret at du har 誅dret folderen for din start menu fra "%s" til "%s". Vil du slette den tidligere start menu folder?
